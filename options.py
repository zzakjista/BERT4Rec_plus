...
# AE #
parser.add_argument('--ae_num_items', type=int, default=None, help='Number of total items')
parser.add_argument('--ae_num_hidden', type=int, default=0, help='Number of hidden layers in AE')
parser.add_argument('--ae_hidden_dim', type=int, default=None, help='Dimension of hidden layer in AE')
parser.add_argument('--ae_latent_dim', type=int, default=None, help="Dimension of latent vector in AE")
parser.add_argument('--ae_dropout', type=float, default=0.5, help='Probability of input dropout in AE')
